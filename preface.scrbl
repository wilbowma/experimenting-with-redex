...
I want the ability to check whether some syntax matches nonterminal in my
language grammar.
...
It is not easy to ask simple questions "is this a term".
...
computes).
It would takes me hours and 100s of lines of code to define the full model and
